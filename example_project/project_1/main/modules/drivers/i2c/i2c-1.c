...
{ 
    char *i2c_dev_path = "/i2c_dev/i2c@1";
    i2c_dev_devicetree = of_find_node_by_path(i2c_dev_path);
    if(i2c_dev_devicetree == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_dev_devicetree not found in dtb\n");return -1;}
    
    char  *data1 = (int *)of_get_property(i2c_dev_devicetree, "status", NULL);
    if(data1 == NULL){printk(KERN_INFO "i2c_1_dev_init: status not found in dtb\n");goto initfaled;}
    if(data1[0] != 'o'){printk(KERN_INFO "i2c_1_dev_init: i2c_dev_status not okay in dtb\n");goto initfaled;}
    printk(KERN_INFO "i2c_1_dev_init: i2c_dev_status okay in dtb\n");
    free(data1);

    printk(KERN_INFO "i2c_1_dev_init: i2c_1 device is enabled in dtb\n");
    int *data  = (int *)of_get_property(i2c_dev_devicetree, "port", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_port not found in dtb\n");goto initfaled;}
    i2c_master_port = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_port is %d\n",i2c_master_port);
    data  = (int *)of_get_property(i2c_dev_devicetree, "freq_hz", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_freq_hz not found in dtb\n");goto initfaled;}
    i2c_master_freq_hz = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_freq_hz is %d\n",i2c_master_freq_hz);
    data  = (int *)of_get_property(i2c_dev_devicetree, "sda_io", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_sda_io not found in dtb\n");goto initfaled;}
    i2c_master_sda_io = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_sda_io is %d\n",i2c_master_sda_io);
    data  = (int *)of_get_property(i2c_dev_devicetree, "scl_io", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_scl_io not found in dtb\n");goto initfaled;}
    i2c_master_scl_io = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_scl_io is %d\n",i2c_master_scl_io);
    data  = (int *)of_get_property(i2c_dev_devicetree, "rx_buf_enable", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_rx_buf_disable not found in dtb\n");goto initfaled;}
    i2c_master_rx_buf_disable = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_rx_buf_disable is %d\n",i2c_master_rx_buf_disable);
    data  = (int *)of_get_property(i2c_dev_devicetree, "tx_buf_enable", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_tx_buf_disable not found in dtb\n");goto initfaled;}
    i2c_master_tx_buf_disable = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_tx_buf_disable is %d\n",i2c_master_tx_buf_disable);
    data  = (int *)of_get_property(i2c_dev_devicetree, "buffer_size", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_buffer_size not found in dtb\n");goto initfaled;}
    i2c_buffer_size = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_buffer_size is %d\n",i2c_buffer_size);
    data  = (int *)of_get_property(i2c_dev_devicetree, "timeout_ms", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_dev_timeout_ms not found in dtb\n");goto initfaled;}
    i2c_dev_timeout_ms = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_dev_timeout_ms is %d\n",i2c_dev_timeout_ms);
    data  = (int *)of_get_property(i2c_dev_devicetree, "retrans_times", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_retrans_times not found in dtb\n");goto initfaled;}
    i2c_retrans_times = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_retrans_times is %ld\n",i2c_retrans_times);
    char *i2c_dev_name_data = (char *)of_get_property(i2c_dev_devicetree, "name", NULL);
    if(i2c_dev_name_data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_dev_name not found in dtb\n");goto initfaled;}
...
{
    if(gpio_request(i2c_master_sda_io, "i2c_sda",i2c_dev_major) != 0){printk(KERN_INFO "i2c_1_dev_init: gpio_request sda failed\n");return -1;}
    if(gpio_request(i2c_master_scl_io, "i2c_scl",i2c_dev_major)!= 0){printk(KERN_INFO "i2c_1_dev_init: gpio_request scl failed\n");gpio_free(i2c_master_sda_io);return -1;}
    return 0;
}
...
void __exit i2c_1_dev_exit(void)
{
    release_gpio_pin();

...
{ 
    ...
    if(i2c_dev_devicetree == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_dev_devicetree not found in dtb");return -1;}
    ...
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_port not found in dtb");goto initfaled;}
    i2c_master_port = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_port is %d",i2c_master_port);
    data  = (int *)of_get_property(i2c_dev_devicetree, "freq_hz", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_freq_hz not found in dtb");goto initfaled;}
    i2c_master_freq_hz = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_freq_hz is %d",i2c_master_freq_hz);
    data  = (int *)of_get_property(i2c_dev_devicetree, "sda_io", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_sda_io not found in dtb");goto initfaled;}
    i2c_master_sda_io = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_sda_io is %d",i2c_master_sda_io);
    data  = (int *)of_get_property(i2c_dev_devicetree, "scl_io", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_scl_io not found in dtb");goto initfaled;}
    i2c_master_scl_io = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_scl_io is %d",i2c_master_scl_io);
    data  = (int *)of_get_property(i2c_dev_devicetree, "rx_buf_enable", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_rx_buf_disable not found in dtb");goto initfaled;}
    i2c_master_rx_buf_disable = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_rx_buf_disable is %d",i2c_master_rx_buf_disable);
    data  = (int *)of_get_property(i2c_dev_devicetree, "tx_buf_enable", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_master_tx_buf_disable not found in dtb");goto initfaled;}
    i2c_master_tx_buf_disable = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_master_tx_buf_disable is %d",i2c_master_tx_buf_disable);
    data  = (int *)of_get_property(i2c_dev_devicetree, "buffer_size", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_buffer_size not found in dtb");goto initfaled;}
    i2c_buffer_size = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_buffer_size is %d",i2c_buffer_size);
    data  = (int *)of_get_property(i2c_dev_devicetree, "timeout_ms", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_dev_timeout_ms not found in dtb");goto initfaled;}
    i2c_dev_timeout_ms = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_dev_timeout_ms is %d",i2c_dev_timeout_ms);
    data  = (int *)of_get_property(i2c_dev_devicetree, "retrans_times", NULL);
    if(data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_retrans_times not found in dtb");goto initfaled;}
    i2c_retrans_times = *data;
    free(data);
    printk(KERN_INFO "i2c_1_dev_init: i2c_retrans_times is %ld",i2c_retrans_times);
    char *i2c_dev_name_data = (char *)of_get_property(i2c_dev_devicetree, "name", NULL);
    if(i2c_dev_name_data == NULL){printk(KERN_INFO "i2c_1_dev_init: i2c_dev_name not found in dtb");goto initfaled;}
